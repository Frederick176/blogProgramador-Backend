...
export const defaultUserAdmin = async (req, res) => {
    const defaultUser = {
        "name": "Fredy",
        "surname": "Hernández",
        "username": "ADMIN1",
        "email": "fhernandez-2023176@gmail.com",
        "profielPicture": "Dragon Ball.jpg",
        "password": "12345678",
        "role": "ADMIN_ROLE",
    }
    ...
    if(!user){
        ...
        console.log(`Admin creado email: ${defaultUser.email}, Username: ${defaultUser.username}, Password: 12345678`);
    }
}
...
export const updatePassword = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            success: true,
            message: "La contraseña actualizada exitosamente!!!"
        })
